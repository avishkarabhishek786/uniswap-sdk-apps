...
const WETH_TO_ERCTOKEN = async (INPUT_TOKEN = {}) => {
    ...
    const dai = await Fetcher.fetchTokenData(chainId, INPUT_TOKEN['address'])
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <div className="input-group">
                                ...
                                <button onClick={() => WETH_TO_ERCTOKEN(defiTokens["USDC"])} className="btn btn-primary">ETH Amount</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <div className="input-group">
                                ...
                                <button onClick={() => ERCTOKEN_TO_WETH(defiTokens["USDC"])} className="btn btn-primary">ETH Amount</button>
                            </div>
                        </div>
                    </div>
                </div>
